...
Listado.prototype.buscarRestaurante = function(id) {
    ...
    */
    ...
    //REFACTORING
     var encontrado = this.restaurantes.find(function(x){
        return x.id == id;
    });
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    */
    ...
    //REFACTORING
    var CuidadSinRepetir = [];
    CuidadSinRepetir = this.restaurantes.map(function(restaurantes){
        return restaurantes.ubicacion;
    });
    ...
    */
    ...
    //REFACTORING
    var CuidadSinRepetirFinal = EliminarRepetidos(CuidadSinRepetir);

    return CuidadSinRepetirFinal.sort();
}
...
Listado.prototype.obtenerRubros = function() {
    ...
    */
    ...
    //REFACTORING
    var RumbrosRestaurantes = [];
    RumbrosRestaurantes = this.restaurantes.map(function(restaurantes){
        return restaurantes.rubro;
    });
    ...
    */
    ...
    //REFACTORING
    var RumbrosRestaurantesFin = EliminarRepetidos(RumbrosRestaurantes);

    return RumbrosRestaurantesFin.sort();
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    */
    ...
    //REFACTORING
    var arregloHorarios = [];
    arregloHorarios = this.restaurantes.map(function(restaurantes){
        return restaurantes.horarios;
    });

    //En este arreglo vamos a poner todos los horarios, uno por uno
    var TodosHorarios = [];
    arregloHorarios.forEach(function(a) {
        a.forEach(function(hora) {
    ...
    */
    ...
    //REFACTORING
    var ArregloHorarioFin = EliminarRepetidos(TodosHorarios);

    return ArregloHorarioFin.sort();
}
...
function EliminarRepetidos(arreglo){
    var resultado = arreglo.filter(function(elem, index, self) {
        return index === self.indexOf(elem);
    });
